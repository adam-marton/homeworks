...
import xyz.codingmentor.webshop.constraint.ColorOfAppleDevice;
import xyz.codingmentor.webshop.constraint.ColorOfSamsungDevice;
...
public class DeviceEntity implements Serializable {
    ...
    public DeviceEntity(DeviceEntity anotherDevice) {
        this.id = anotherDevice.id;
        this.manufacturer = anotherDevice.manufacturer;
        this.type = anotherDevice.type;
        this.price = anotherDevice.price;
        this.color = anotherDevice.color;
        this.count = anotherDevice.count;
    }
